<template>
  <div class="team">
    ...
    <v-list-item  >
      ...
      <v-list-item-content> <!-- 첫번째 상자 -->
        <div class="overline text-right">1</div>
        <v-list-item-title class="headline mb-1 text-right" >일 </v-list-item-title>
        <div><v-divider></v-divider></div> <!-- 밑줄 -->
      </v-list-item-content> 
    </v-list-item>
    <v-card-actions>
    ...
    <v-list-item>
      ...
      <v-list-item-content> <!-- 두번쨰 상자 -->
        <div class="overline text-right">222</div>
        <v-list-item-title class="headline mb-1 text-right" >222</v-list-item-title>
    ...
    <v-list-item>
      ...
      <v-list-item-content> <!-- 세번째 상자 -->

        <div class="overline text-right">333</div>
        <v-list-item-title class="headline mb-1 text-right" >세번쨰</v-list-item-title>
        <div><v-divider></v-divider></div>
      </v-list-item-content> 
    </v-list-item>
    <v-card-actions>
    ...
    <v-list-item >
      ...
      <v-list-item-content> <!-- 4번쨰 상자 -->
        <div class="overline text-right">444</div>
        <v-list-item-title class="headline mb-1 text-right" >4444</v-list-item-title>
        <div><v-divider></v-divider></div>
      </v-list-item-content> 
    </v-list-item>
    <v-card-actions>
      ...
      <div class="overline">Prodect</div>
        ...
        <v-flex xs12 sm6 md4 lg3 v-for="person in team" :key="person.name">
              <v-card class="text-center ma-3">
                ...
                <v-card-text>
                  <div class="subheading">{{person.name}}</div> <!-- subheading -->
                  <div class="black--text">{{person.role}}</div> <!-- 글자색 -->
                </v-card-text>
                <v-card-actions>
